...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'proxy/client-interface-connected': return `[toolbox] Klient ${tokens.justStarted ? 'połączony' : 'połączony ponownie'} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1)`;
        ...
        case 'proxy/warning-unmapped-protocol-1': return `[toolbox] OSTRZEŻENIE: Niezmapowana wersja protokołu ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1).`;
        ...
        case 'proxy/error-cannot-load-protocol': return `BŁĄD: Wystąpił problem z załadowaniem wersji protokołu ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1)!`;
        case 'proxy/protocol-loaded': return `[toolbox] Załadowano wersję protokołu ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1).`;
