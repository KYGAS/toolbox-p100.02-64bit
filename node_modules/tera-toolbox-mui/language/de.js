...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'proxy/client-interface-connected': return `[Toolbox] Verbindung zum Client wurde ${tokens.justStarted ? 'hergestellt' : 'wieder hergestellt'} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1)`;
        ...
        case 'proxy/warning-unmapped-protocol-1': return `[Toolbox] WARNUNG: Nicht zugeordnete Protokoll-Version ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1) gefunden.`;
        ...
        case 'proxy/error-cannot-load-protocol': return `FEHLER: Protokoll-Version ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1) konnte nicht geladen werden!`;
        case 'proxy/protocol-loaded': return `[Toolbox] Protokoll-Version ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1) wurde erfolgreich geladen.`;
