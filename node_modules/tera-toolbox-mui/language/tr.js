...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'proxy/client-interface-connected': return `[ToolBox] İstemci ${tokens.justStarted ? 'connected' : 'reconnected'} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1)`;
        ...
        case 'proxy/warning-unmapped-protocol-1': return `[ToolBox] UYARI: Atanmayan protocol sürümü ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1).`;
        ...
        case 'proxy/error-cannot-load-protocol': return `HATA: Protokol sürümü yüklenemedi ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1)!`;
        case 'proxy/protocol-loaded': return `[ToolBox] Yüklenen protokol sürümü ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1).`;
