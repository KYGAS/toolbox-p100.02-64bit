...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'proxy/client-interface-connected': return `[toolbox] cliente ${tokens.justStarted ? 'conectado' : 're-conectado'} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1)`;
        ...
        case 'proxy/warning-unmapped-protocol-1': return `[toolbox] ATENCIÓN: Versión del protocolo sin mapear ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1).`;
        ...
        case 'proxy/error-cannot-load-protocol': return `ERROR: Imposible cargar la versión del protocolo ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1)!`;
        case 'proxy/protocol-loaded': return `[toolbox] Versión del protocolo cargada: ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1).`;
