...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'proxy/client-interface-connected': return `[toolbox] Client ${tokens.justStarted ? 'connesso' : 'riconnesso'} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1)`;
        ...
        case 'proxy/warning-unmapped-protocol-1': return `[toolbox] ATTENZIONE: Versione del protocollo non mappata ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1).`;
        ...
        case 'proxy/error-cannot-load-protocol': return `ERRORE: Impossibile caricare la versione del protocollo ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1)!`;
        case 'proxy/protocol-loaded': return `[toolbox] Caricata versione del protocollo ${tokens.protocolVersion} (Publisher: ${tokens.publisher.toUpperCase()} - CLient: ${tokens.majorPatchVersion}.${tokens.minorPatchVersion} - Server: 104.1).`;
